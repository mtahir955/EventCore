...
export function HeroSection() {
  ...
  return (
    <section className="relative rounded-[40px] mt-3 mx-4 md:mx-10 h-auto lg:h-[550px] bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 dark:from-gray-900 dark:via-gray-800 dark:to-black overflow-hidden">
      {/* Background Image */}
      ...
      {/* Content */}
      <div className="relative z-20 max-w-7xl mx-auto px-6 pt-10 lg:pt-8">
        <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[80vh]">
          {/* Left Content */}
          <div className="space-y-4 mt-20 md:mt-28 lg:mt-56 text-center lg:text-left">
            {/* Tag */}
            <div className="inline-flex items-center space-x-2 bg-black/50 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 mx-auto lg:mx-0">
            ...
            <div className="space-y-2">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#D19537] italic leading-tight">
                Great Event
              </h1>
            </div>
          ...
          {/* Right Content */}
          <div className="relative flex flex-col sm:ml-60 items-center lg:items-start sm:pt-60 lg:mt-0">
            {/* Next Event label */}
            ...
            {/* Video Preview Card */}
            <div className="relative w-full max-w-[300px] sm:max-w-[360px] md:max-w-[300px] aspect-video bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl overflow-hidden shadow-lg">
              <img
                src="/images/modern-venue.jpg"
                alt="Event preview"
                className="w-full h-full object-cover"
              />
            ...
            {/* Caption */}
            <div className="mt-3 text-white font-medium">Watch Video</div>
          </div>
        </div>
      </div>
