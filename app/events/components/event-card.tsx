...
export function EventCard({ event }: EventCardProps) {
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-[#212121] shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col">
      {/* Image */}
...
//   return (
//     <div className="group relative overflow-hidden rounded-2xl h-[350px] bg-white dark:bg-[#212121] shadow-lg hover:shadow-xl transition-all duration-300">
//       {/* Image Container */}
